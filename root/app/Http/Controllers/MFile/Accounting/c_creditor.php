...
class c_creditor extends Controller
{
    public function __construct()
    {
        $this->MOD_CODE = "M1000008";
        ...
        $this->m04 = DB::table(DB::raw("rssys.m04"))->where([['sl', '=' , 'Y'], ['active', '=', TRUE]])->get(); 
    ...
    public function view() // TO VIEW SUPPLIER MODULE
    {
        ...
        return view('masterfile.accounting.masterfile-accounting_creditor', ['m07'=>$this->m07, 'm10'=>$this->m10, 'm04' => $this->m04]);
    }

    public function get() // TO GET SUPPLIERS MODULE
    {
    ...
    public function delete(Request $r) // TO REMOVE EXISTING SUPPLIER MODULE
    {
        $grp = Session::get('grp_ri');
