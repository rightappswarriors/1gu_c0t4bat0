...
class c_sub_cost_center extends Controller
{
    //
    public function __construct()
    {
        $this->MOD_CODE = "M1000010";
    ...
    public function view() // TO VIEW SUB COST CENTER MODULE
    {
        ...
        return view('masterfile.accounting.masterfile-accounting_sub_cost_center', ['subctr' => $this->subctr, 'm08' => $this->m08]);
    }
