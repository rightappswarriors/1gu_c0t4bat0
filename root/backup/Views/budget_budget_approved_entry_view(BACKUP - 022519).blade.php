...
@php
    $_bc = [
        ...
        ['link'=>url("budget/budget-approved-entry/new"),'desc'=>'View','icon'=>'none','st'=>true]
    ];
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="" disabled="" value="@if(isset($bgt01)){{$bgt01->fy}}@endif">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="budget_period_text" disabled="" value="">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control EditBudgetProposal" name="hdr_bgtps01" value="@isset($bgt01){{$bgt01->bgtps_bnum}}@endisset" disabled>
                    </div>
                </div>
                {{-- <div class="col-md-2">
                    <div class="form-group">
                                                ...
                                                @for($j = 0; $j < count($bgt02); $j++)
                                                    @if($ppa[$i]->subgrpid == $bgt02[$j]->grpid)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <center class="amt" amt="{{$bgt02[$j]->allot_amnt}}">Php {{number_format($bgt02[$j]->allot_amnt, 2, ".", ", ")}}</center>
                                                            </td>
                        ...
                        @isset($bgt02)
                            @foreach ($bgt02 as $b)
                                <tr>
                                    <td>{{$b->seq_num}}</td>
                                    <td>
                                        <span class="cc_code" cc-code="{{$b->at_code}}">{{$b->at_code}}</span>
                                    </td>
                                    <td>{{$b->at_desc}}</td>
                                    <td>
                                        <span class="subgrpid" subgrpid="{{$b->grpid}}">{{$b->subgrpdesc}}</span>
                                    </td>
                                    <td>
                                        <center class="amt" amt="{{$b->allot_amnt}}">Php {{number_format($b->allot_amnt, 2, ".", ", ")}}</center>
                                    </td>
                                </tr>
                            @endforeach
                        @endisset
...
<script>
	...
	$(document).ready(function(){
        ...
        @isset($bgt01)
            ...
            @endisset
            @isset($bgt01->budget_period)
                $('select[name="budget_period"]').val('{{$bgt01->budget_period}}').trigger('change');
                $('input[name="budget_period_text"]').val('{!!$bgt01->budget_desc!!}');
            @endisset
