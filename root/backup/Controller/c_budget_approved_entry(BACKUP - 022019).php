...
class c_budget_approved_entry extends Controller
{
    ...
    {
        return view('budget.budget_budget_approved_entry_new', ['ppa' => $this->ppa, 'budget_period' => $this->budget_period, 'x03' => $this->x03, 'm04' => $this->m04]);
    }
    ...
    public function getAllProposalEntries(Request $r)
    {
    ...
    public function getProposal(Request $r)
    {
        $sql = 'SELECT * FROM rssys.bgtps01
