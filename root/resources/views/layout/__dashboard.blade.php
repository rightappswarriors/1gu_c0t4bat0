@if(count($grpid) > 0)
  ...
  <div id="removeDataAfter" hidden>
    ...
    <div id="getData7" class="getDataClass">
  ...
  <script src="{{ asset('root/public/js/forall.js') }}"></script>
  <script type="text/javascript">
    var defaultData = { defaultLeft: ["getData1", "getData3", "getData5", "getData7"], defalutRight: ["getData4", "getData2", "getData6"] }, dataSet = ['setDataLeft', 'setDataRight'], dataCount = ['defaultLeft', 'defalutRight'], setData = { setDataLeft: [], setDataRight: [] }, setDataCount = ['setDataLeft', 'setDataRight'], grpid = JSON.stringify({!!$grpid[0]->w_json!!}), n_grpid = JSON.stringify({!!$n_grpid[0]->w_custom_json!!});
