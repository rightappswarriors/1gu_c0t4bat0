...
@php
    $_bc = [
        ...
        ['link'=>'#','desc'=>'Stock Adjustment','icon'=>'none','st'=>false],
...
@section('content')
    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Stock Adjustment Info</h3>
          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group" style="display: flex;">
                <a href="{{route('inventory.stockadjustment')}}" class="btn btn-block btn-primary"><i class="fa fa-arrow-left"></i> Go Back</a>
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group" style="display: flex;">
    ...
    <script>
      ...
      function set_tbl_itemlist()
      {
        ...
        table.row.add([line, part_no, item_code, item_desc, qty, unit_code, unit_desc, cost_price, line_amnt, remarks, buttons]).draw();

        }
        else if($('#ENTER_ITEM').text() == 'Edit') // edit item
        {
          table.row(selectedRow).data([line, part_no, item_code, item_desc, qty, unit_code, unit_desc, cost_price, line_amnt, remarks, buttons]).draw();
        }
        else // remove item
        {
      ...
      function Save()
      {
        ...
        var data = { 
           ...
           $.ajax({
                  url: '{{asset('inventory/stockadjustment/edit')}}/'+rec_num,
                  method: 'POST',
                  data: data,
