...
@php
    $_bc = [
        ...
        ['link'=>'#','desc'=>'Receiving Stock Transfer','icon'=>'none','st'=>false],
        ['link'=>'#','desc'=>'Create','icon'=>'none','st'=>true],
    ];
    $_ch = "Receiving Stock Transfer"; // Module Name
@endphp
@section('content')
    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Receiving Stock Transfer Info</h3>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="date" class="form-control pull-right" id="datepicker" name="dtp_invoicedt" value="{{$rechdr->trnx_date}}" disabled="">
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="select_stocklocationfrom" disabled="">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="select_stocklocationto" disabled="">
                  @foreach($stock_loc as $st)
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="txt_reference" value="{{$rechdr->_reference}}" disabled="">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label>Branch</label>
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true", name="select_branch" disabled="">
                  @foreach($branch as $b)
          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group" style="display: flex;">
                <a href="{{route('inventory.recvstocktransfer')}}" class="btn btn-block btn-primary"><i class="fa fa-arrow-left"></i> Go Back</a>
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group" style="display: flex;">
              ...
              <div class="modal fade in" id="enteritem-modal">
                <div class="modal-dialog">
                  <div class="modal-content">
                          ...
                          <div class="col-sm-3">
                            <div class="form-group">
                              <label>Received Quantity</label>
                                <input id="txt_recvqty" type="text" class="form-control" name="txt_recvqty" placeholder="0.00" required="">
                            </div>
                          </div>
                          <div class="col-sm-3">
                            <div class="form-group">
                    ...
                    <div class="modal-footer">
                      <span class="AddMode EditMode">
                        <button type="button" class="btn btn-prima ry" onclick="set_tbl_itemlist()">Save</button>
                      </span>
                      <span class="DeleteMode">
    ...
    <script>
      ...
      function EnterItem_Edit(line)
      {
          ...
          $('input[name="txt_recvqty"]').val(data[5]);
          $('select[name="select_unit"]').val(data[6]).trigger('change');
          $('input[name="txt_cost"]').val(data[8]);
      ...
      function set_tbl_itemlist()
      {
        ...
        var recv_qty = $('input[name="txt_recvqty"]').val();
        ...
        table.row.add([line, part_no, item_code, item_desc, qty, recv_qty, unit_code, unit_desc, cost_price, line_amnt, buttons]).draw();

        }
        else if($('#ENTER_ITEM').text() == 'Edit') // edit item
        {
          table.row(selectedRow).data([line, part_no, item_code, item_desc, qty, recv_qty, unit_code, unit_desc, cost_price, line_amnt, buttons]).draw();
        }
        else // remove item
        {
      ...
      function Save()
      {
        ...
        var data = { 
           ...
           $.ajax({
                  url: '{{asset('inventory/recvstocktransfer/edit')}}/'+rec_num,
                  method: 'POST',
                  data: data,
                  success : function(flag)
                           {
                              ...
                              {
                                console.log(flag);
                                location.href= "{{route('inventory.recvstocktransfer')}}";
                              }
                              else
                              {
