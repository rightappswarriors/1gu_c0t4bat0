...
@section('content')
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Waste Material List</h3>
              <a href="{{route('inventory.wastematerial_add')}}"><button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create</button></a>
      ...
      <script>
        ...
        function cancel()
        {
           ...
           $.ajax({
                     url: '{{asset('inventory/wastematerial/wastematerial_cancel')}}/'+code,
                     method: 'GET',
