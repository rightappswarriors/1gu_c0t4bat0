...
@php
    $_bc = [
        ...
        ['link'=>'#','desc'=>'Biological Disposition','icon'=>'none','st'=>true]
    ];
    ...
    @include('layout._contentheader')
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Create Disposition List</h3>
              <a href="{{route('inventory.biologydisposition_add')}}"><button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create</button></a>
      ...
      $('#tbl_list').DataTable( {
        ...
        function cancel()
        {
           ...
           $.ajax({
                     type: 'POST',
                     url: '{{route('inventory.bioDispo_cancel')}}',
                     data : {code: id},
                     dataTy : 'json',
