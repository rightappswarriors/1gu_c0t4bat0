...
@php
    $_bc = [
        ...
        ['link'=>'#','desc'=>'Biological Offspring','icon'=>'none','st'=>true]
    ];
    ...
    @include('layout._contentheader')
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Create Offspring List</h3>
              <a href="{{route('inventory.biologyoffspring_add')}}"><button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create</button></a>
            ...
            <div class="box-body">
              <table id="tbl_list" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$d->reference}}</td>
                  <td>
                    <center><a class="btn btn-social-icon btn-warning" href="{{route('inventory.biologyoffspring_edit', $d->code)}}"><i class="fa fa-pencil"></i></a>&nbsp;<a class="btn btn-social-icon btn-danger" data-toggle="modal" data-target="#cancel-modal"><i class="fa fa-close"></i></a></center></td>
                </tr>
                @endforeach
                </tbody>
              </table>
      ...
      $('#tbl_list').DataTable( {
        ...
        function cancel()
        {
           ...
           $.ajax({
                     type: 'POST',
                     url: '{{route('inventory.bioBoo_cancel')}}',
                     data : {code: id},
                     dataTy : 'json',
