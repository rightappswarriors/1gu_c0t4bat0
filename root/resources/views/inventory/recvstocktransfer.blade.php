...
@php
    $_bc = [
        ...
        ['link'=>'#','desc'=>'Receiving Stock Transfer','icon'=>'none','st'=>true]
    ];
...
@section('content')
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Receiving Stock Transfer List</h3>
            ...
            <div class="box-body">
              <table id="tbl_list" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$d->loc_to}}</td>
                  <td>{{$d->branch}}</td>
                  <td><center><a class="btn btn-social-icon btn-warning" href="{{route('inventory.rst_edit', $d->rec_num)}}"><i class="fa fa-pencil"></i><!-- </a>&nbsp;<a class="btn btn-social-icon btn-danger" data-toggle="modal" data-target="#cancel-modal"><i class="fa fa-close"></i></a> --></center></td>
                </tr>
                @endforeach
                @endisset
                </tbody>
      ...
      <script>
        ...
        function cancel()
        {
           ...
           $.ajax({
                     url: '{{asset('inventory/recvstocktransfer/cancel')}}/'+code,
                     method: 'GET',
