		      ...
		      <div class="row" >
		        <div class="col-sm-12" >
		          ...
		          <table style="border-top: hidden;margin-bottom: 0px;"  id="tbl_list" class="table table-bordered table-striped">
		          	<thead>
		          		<tr>
		          			<td width="30%" style="padding: 4px;border-bottom: hidden !important;">Division: <u></u></td>
		          			<td width="25%" style="padding: 4px;border-bottom: hidden !important;">Responsibility Center</td>
		          			<td style="padding: 4px;border-right:hidden !important;border-bottom: hidden !important; ">RIS NO. <u></u></td>
		          			<td style="padding: 4px;border-left:hidden !important;border-bottom: hidden !important;">Date: <u></u></td>
		          		</tr>
		          		<tr>
		          			<td style="padding: 4px;border-top: hidden !important;">Office: <u></u></td>
		          			<td style="padding: 4px;border-top: hidden !important">Code: <u></u></td>
		          			<td style="padding: 4px;border-right:hidden !important;border-top: hidden !important;">SAI NO. <u></u></td>
