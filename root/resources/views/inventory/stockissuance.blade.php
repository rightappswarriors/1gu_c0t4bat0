...
@php
    $_bc = [
        ...
        ['link'=>'#','desc'=>'Stock Issuance','icon'=>'none','st'=>true]
    ];
...
@section('content')
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{route('inventory.si_add')}}"><button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create</button></a>
            ...
            <div class="box-body">
              <table id="tbl_list" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$d->trnx_date}}</td>
                  <td>{{$d->recipient}}</td>
                  <td><center><a class="btn btn-social-icon btn-warning" href="{{route('inventory.si_edit', $d->rec_num)}}"><i class="fa fa-pencil"></i></a>&nbsp;<a class="btn btn-social-icon btn-danger" data-toggle="modal" data-target="#cancel-modal"><i class="fa fa-close"></i></a></center></td>
                </tr>
                @endforeach
                </tbody>
                <tfoot>
      ...
      <script>
        ...
        function cancel()
        {
           ...
           $.ajax({
                     url: '{{asset('inventory/stockissuance/cancel')}}/'+code,
                     method: 'GET',
