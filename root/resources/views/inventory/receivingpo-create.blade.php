...
@section('content')
    ...
    <script>
      ...
      function EnterItem_Edit(line)
      {
          ...
          $('input[name="txt_part_no"]').val(data[1]);
      ...
      function set_tbl_itemlist()
      {
        ...
        var buttons = '<center>' +
              '<a class="btn btn-social-icon btn-warning"><i class="fa fa-pencil" onclick="EnterItem_Edit( \''+line+'\');"></i></a>&nbsp;' +
                            '<a class="btn btn-social-icon btn-danger" data-toggle="modal" data-target="#modal-default" onclick="DeleteMode(\''+line+'\');"><i class="fa fa-trash "></i></a>' +
            '</center>';
