...
@php
    $_bc = [
        ...
        ['link'=>url("reports/budget/proposal"),'desc'=>'Proposal','icon'=>'none','st'=>true],
    ];
    $_ch = "Generate Budget Proposal Report"; // Module Name
@endphp
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Generate Budget Proposal <span id="MOD_MODE"></span></h4>
                </div>
