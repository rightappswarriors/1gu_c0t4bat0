...
<style>
      ...
      <form method="POST">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <input type="date" disabled="" value="{{Date('Y-m-d',strtotime('now'))}}" class="form-control" name="date_issued" id="dIssue">
            </div>
          </div>
          {{-- forms --}}
          <div class="row">
            ...
            <div class="col-md-4">
               <select disabled="" class="form-control" name="or_type" id="or_form">
          ...
          <div class="row">
            <div class="col-md-6" style="padding-left: 0px!important;">
              ...
              <div class="col-md-8">
                <input disabled="" type="number" class="form-control" name="or_no" placeholder="OR No. From" id="orFrom">
              </div>
            </div>
            <div class="col-md-6" style="padding-left: 0px!important;">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
               <select disabled="" class="form-control" name="collector" id="collector">
  ...
  <script type="text/javascript">
    ...
    document.getElementsByName('or_no_to')[0].value = "{{$or_issuance[0]->toeditor}}";
