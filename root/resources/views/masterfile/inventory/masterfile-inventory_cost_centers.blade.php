...
@php
    $_bc = [
        ...
        ['link'=>url("master-file/inventory/cost-center"),'desc'=>'Cost Center','icon'=>'none','st'=>true]
    ];
...
@section('content')
	...
	<script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#SideBar_MFile_COST_CENTER').addClass('text-green');
        ...
        {
            $('#MOD_MODE').text('(New)');
            $('#AddForm').attr('action', '{{ url('master-file/inventory/cost-center') }}');
        ...
        {
            $('#MOD_MODE').text('(Edit)');
            $('#AddForm').attr('action', '{{ url('master-file/inventory/cost-center') }}/update');
        ...
        function DeleteMode(id, desc)
        {
            ...
            $('#AddForm').attr('action', '{{ url('master-file/inventory/cost-center') }}/delete');
            $('input[name="txt_id"]').val(id);
