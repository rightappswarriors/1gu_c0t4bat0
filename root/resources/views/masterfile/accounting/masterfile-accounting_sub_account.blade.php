...
@php
    $_bc = [
        ...
        ['link'=>url("master-file/accounting/sub-account"),'desc'=>'Sub Account','icon'=>'none','st'=>true]
    ];
    $_ch = "Sub Account"; // Module Name
@endphp
@section('content')
        						...
        						<div class="modal-dialog">
        							<div class="modal-content">
        								<div class="modal-header">
                                            ...
                                            <h3 class="modal-title">Sub Account <span id="MOD_MODE"></span></h3>
                                        </div>
                                	...
                                	@isset($data[1])
                                        @foreach($data[1] as $m01)
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                       <a class="btn btn-social-icon btn-warning" data-toggle="modal" data-target="#modal-default"><i class="fa fa-pencil" onclick="EditMode('{{$m01->cmp_code}}', '{{$m01->cmp_desc}}', '{{$m01->mag_code}}');"></i></a>
                                                       <a class="btn btn-social-icon btn-danger" data-toggle="modal" data-target="#modal-default" onclick="DeleteMode('{{$m01->cmp_code}}', '{{$m01->cmp_desc}}');"><i class="fa fa-trash "></i></a>
                                                    </center>
                                                </td>
                                            </tr>
                                        @endforeach
	...
	<script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#SideBar_MFile_Accounting_Sub_Account').addClass('text-green');
        });
        function AddMode()
        {
            $('#MOD_MODE').text('(New)');
